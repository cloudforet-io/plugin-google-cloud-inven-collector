...
from spaceone.inventory.model.cloud_storage.bucket.cloud_service_type import CLOUD_SERVICE_TYPES
from spaceone.inventory.model.cloud_storage.bucket.cloud_service import StorageResource, StorageResponse
