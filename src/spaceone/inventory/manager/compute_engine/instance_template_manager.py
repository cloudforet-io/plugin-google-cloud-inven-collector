...
from spaceone.inventory.model.compute_engine.instance_template.cloud_service_type import CLOUD_SERVICE_TYPES
from spaceone.inventory.model.compute_engine.instance_template.cloud_service import InstanceTemplateResource, \
    InstanceTemplateResponse
from spaceone.inventory.model.compute_engine.instance_template.data import InstanceTemplate, InstanceGroup, Disk
    ...
    def collect_cloud_service(self, params):
        ...
        for inst_template in instance_templates:
            try:
                ...
                error_response = self.generate_resource_error_response(e, 'ComputeEngine', 'InstanceTemplate',
                                                                       inst_template_id)
