...
class AppEngineApplicationV1Manager(GoogleCloudManager):
    ...
    def get_application(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if application:
                _LOGGER.info(f"Retrieved App Engine application (v1)")
    ...
    def collect_cloud_service(
        ...
        """App Engine 애플리케이션 정보를 수집합니다 (v1 API)."""
        _LOGGER.debug(f"** App Engine Application V1 START **")
        ...
        if application:
            try:
                ...
                app_data = {
                    ...
                    "defaultCookieExpiration": str(application.get("defaultCookieExpiration", "")),
                ...
                if "featureSettings" in application:
                    ...
                    app_data["featureSettings"] = {
                        "splitHealthChecks": str(feature_settings.get("splitHealthChecks", "")),
                        "useContainerOptimizedOs": str(feature_settings.get("useContainerOptimizedOs", "")),
                    }
                ...
                if "iap" in application:
                    ...
                    app_data["iap"] = {
                        ...
                        "oauth2ClientSecret": str(iap_settings.get("oauth2ClientSecret", "")),
                    }
                ...
                app_response = AppEngineApplicationResponse({
                ...
                error_responses.append(
                    self.generate_error_response(e, self.cloud_service_group, "Application")
                )
        
        _LOGGER.debug(f"** App Engine Application V1 END **")
