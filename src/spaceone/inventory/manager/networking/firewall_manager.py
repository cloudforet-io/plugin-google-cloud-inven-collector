...
from spaceone.inventory.model.networking.firewall.cloud_service_type import CLOUD_SERVICE_TYPES
from spaceone.inventory.model.networking.firewall.cloud_service import FirewallResource, FirewallResponse
