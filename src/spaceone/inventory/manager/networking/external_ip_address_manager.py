...
from spaceone.inventory.model.networking.external_ip_address.data import ExternalIpAddress
from spaceone.inventory.connector.networking.external_ip_address import ExternalIPAddressConnector
from spaceone.inventory.model.networking.external_ip_address.cloud_service_type import CLOUD_SERVICE_TYPES
