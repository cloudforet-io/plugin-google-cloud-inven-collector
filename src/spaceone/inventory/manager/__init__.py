...
from spaceone.inventory.manager.recommender.insight_manager import InsightManager
from spaceone.inventory.manager.recommender_v2.recommendation_manager import RecommendationManager
