...
class ServiceConfig(Model):
    ...
    timeout_seconds = IntType(serialize_when_none=False, deserialize_from='timeoutSeconds')
    ...
    all_traffic_on_latest_revision = BooleanType(serialize_when_none=False,
                                                 deserialize_from='allTrafficOnLatestRevision')
    ...
    secret_volumes = ListType(ModelType(SecretVolume, serialize_when_none=False, deserialize_from='secretVolumes'))
