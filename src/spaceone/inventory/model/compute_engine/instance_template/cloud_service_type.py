...
cst_instance_template._metadata = CloudServiceTypeMeta.set_meta(
    fields=[
        ...
        TextDyField.data_source(
            "Self Link", "data.self_link", options={"is_optional": True}
        ),
        ListDyField.data_source(
            "Network Tags",
            "data.network_tags",
        ...
        TextDyField.data_source(
            "Fingerprint", "data.fingerprint", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Machine Type", "data.machine_type", options={"is_optional": True}
        ),
