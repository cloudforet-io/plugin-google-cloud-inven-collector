...
count_by_instance_type_conf = os.path.join(
    current_dir, "widget/count_by_instance_type.yml"
)
...
cst_vm_instance._metadata = CloudServiceTypeMeta.set_meta(
    fields=[
        ...
        TextDyField.data_source(
            "Server ID", "server_id", options={"is_optional": True}
        ),
        ...
        TextDyField.data_source(
            "Preemptible",
            "data.compute.scheduling.preemptible",
        ...
        TextDyField.data_source(
            "Total GPU Count", "data.total_gpu_count", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "GPUs",
            "data.display.gpus",
        ...
        TextDyField.data_source(
            "Instance ID", "data.compute.instance_id", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Key Pair", "data.compute.keypair", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Image", "data.compute.image", options={"is_optional": True}
        ),
        TextDyField.data_source("Availability Zone", "data.compute.az"),
        TextDyField.data_source(
            "OS Type", "data.os.os_type", options={"is_optional": True}
        ),
        TextDyField.data_source("OS", "data.os.os_distro"),
        TextDyField.data_source(
            "OS Architecture", "data.os.os_arch", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Primary IP", "data.primary_ip_address", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Public IP", "data.compute.public_ip_address", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Public DNS", "data.nics.tags.public_dns", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "All IP", "ip_addresses", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "MAC Address", "data.nics.mac_address", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "CIDR", "data.nics.cidr", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "VPC ID", "data.vpc.vpc_id", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "VPC Name", "data.vpc.vpc_name", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Subnet ID", "data.subnet.subnet_id", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Subnet Name", "data.subnet.subnet_name", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "LB Name", "data.load_balancers.name", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "LB DNS", "data.load_balancers.dns", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Managed Instance",
        ...
        TextDyField.data_source(
            "Disk Write IOPS",
            "data.monitoring.disk.write_iops.avg",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Average)",
        ...
        SizeField.data_source(
            ...
            "data.monitoring.disk.read_throughput.avg",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Average)",
        ...
        SizeField.data_source(
            ...
            "data.monitoring.disk.write_throughput.avg",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Average)",
        ...
        TextDyField.data_source(
            "Network Received PPS",
            "data.monitoring.network.received_pps.avg",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Average)",
        ...
        TextDyField.data_source(
            "Network Sent PPS",
            "data.monitoring.network.sent_pps.avg",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Average)",
        ...
        SizeField.data_source(
            ...
            "data.monitoring.network.received_throughput.avg",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Average)",
        ...
        SizeField.data_source(
            ...
            "data.monitoring.network.sent_throughput.avg",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Average)",
        ...
        TextDyField.data_source(
            "Disk Read IOPS",
            "data.monitoring.disk.read_iops.max",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Max)",
        ...
        TextDyField.data_source(
            "Disk Write IOPS",
            "data.monitoring.disk.write_iops.max",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Max)",
        ...
        SizeField.data_source(
            "Disk Read Throughput",
            "data.monitoring.disk.read_throughput.max",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Max)",
        ...
        SizeField.data_source(
            "Disk Write Throughput",
            "data.monitoring.disk.write_throughput.max",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Max)",
        ...
        TextDyField.data_source(
            "Network Received PPS",
            "data.monitoring.network.received_pps.ma",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Max)",
        ...
        TextDyField.data_source(
            "Network Sent PPS",
            "data.monitoring.network.sent_pps.max",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Max)",
        ...
        SizeField.data_source(
            "Network Received Throughput",
            "data.monitoring.network.received_throughput.max",
            options={
                "default": 0,
                "is_optional": True,
                "field_description": "(Daily Max)",
        ...
        TextDyField.data_source(
            "Launched", "launched_at", options={"is_optional": True}
        ),
    ],
    search=[
        ...
        SearchField.set(
            name="Has GPU", key="data.display.has_gpu", data_type="boolean"
        ),
        SearchField.set(
            name="Total GPU Count", key="data.total_gpu_count", data_type="integer"
        ),
        ...
        SearchField.set(
            name="OS Type",
            key="data.os.os_type",
            enums={"LINUX": {"label": "Linux"}, "WINDOWS": {"label": "Windows"}},
        ),
