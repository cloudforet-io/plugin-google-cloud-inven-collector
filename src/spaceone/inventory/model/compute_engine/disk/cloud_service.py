...
schedule_meta = TableDynamicLayout.set_fields(
    "Snapshot Schedule",
    root_path="data.snapshot_schedule",
    fields=[
        ...
        ListDyField.data_source(
            ...
            "snapshot_schedule_policy.schedule_display",
            default_badge={"type": "outline", "delimiter": "<br>"},
        ),
...
class DiskResource(ComputeEngineResource):
    ...
    data = ModelType(Disk)
    _metadata = ModelType(
        CloudServiceMeta, default=disk_meta, serialized_name="metadata"
    )
