...
cst_disk._metadata = CloudServiceTypeMeta.set_meta(
    fields=[
        ...
        TextDyField.data_source(
            "Source Image", "data.source_image_display", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Read IOPS", "data.read_iops", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Write IOPS", "data.write_iops", options={"is_optional": True}
        ),
        TextDyField.data_source(
