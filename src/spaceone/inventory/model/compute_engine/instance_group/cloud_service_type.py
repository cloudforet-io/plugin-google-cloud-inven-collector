...
cst_instance_group._metadata = CloudServiceTypeMeta.set_meta(
    fields=[
        TextDyField.data_source(
            "Instance Group ID", "data.id", options={"is_optional": True}
        ),
        ...
        TextDyField.data_source(
            "Region", "data.display_location.region", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Zone", "data.display_location.zone", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Network", "data.network", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Subnet", "data.subnetwork", options={"is_optional": True}
        ),
        TextDyField.data_source(
    ...
    search=[
        ...
        SearchField.set(
            ...
            key="data.autoscaler.autoscaling_policy.min_num_replicas",
            data_type="integer",
        ),
        SearchField.set(
            name="Maximum Number of Replicas",
            key="data.autoscaler.autoscaling_policy.max_num_replicas",
            data_type="integer",
        ),
        SearchField.set(
            name="Recommended Size",
            key="data.autoscaler.recommended_size",
            data_type="integer",
        ),
