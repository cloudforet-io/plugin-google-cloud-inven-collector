...
# TAB - Firewall
firewall_detail_meta = ItemDynamicLayout.set_fields('Firewall Details', fields=[
...
firewall_applicable_inst_meta= TableDynamicLayout.set_fields('Applicable to Instances',  root_path='data.applicable_instance', fields=[
...
instance_template_meta = CloudServiceMeta.set_layouts([firewall_detail_meta,
                                                       firewall_applicable_inst_meta])
