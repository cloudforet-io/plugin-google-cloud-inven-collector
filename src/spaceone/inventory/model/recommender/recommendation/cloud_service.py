...
recommender_details = ItemDynamicLayout.set_fields(
    "Recommender Details",
    fields=[
...
detail_meta = ListDynamicLayout.set_layouts("Details", layouts=[recommender_details])
...
recommendations_meta = ListDynamicLayout.set_layouts(
    "Recommendations", layouts=[detail_recommendations_meta]
)
...
class RecommendationResource(RecommenderResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=recommendation_meta, serialized_name="metadata"
    )
