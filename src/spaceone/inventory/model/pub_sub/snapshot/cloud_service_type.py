...
cst_pub_sub_snapshot.group = "PubSub"
...
cst_pub_sub_snapshot.tags = {"spaceone:icon": f"{ASSET_URL}/cloud_pubsub.svg"}
...
cst_pub_sub_snapshot._metadata = CloudServiceTypeMeta.set_meta(
    ...
    search=[
        ...
        SearchField.set(
            name="Expiration", key="data.expire_time", data_type="datetime"
        ),
