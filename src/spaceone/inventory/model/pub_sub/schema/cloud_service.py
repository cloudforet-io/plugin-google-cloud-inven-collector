...
schema_details = ItemDynamicLayout.set_fields('Schema', fields=[
...
schema_meta = ListDynamicLayout.set_layouts('Details', layouts=[schema_details, definition])
...
class SchemaResource(PubSubResource):
    ...
    _metadata = ModelType(CloudServiceMeta, default=schema_meta, serialized_name='metadata')
