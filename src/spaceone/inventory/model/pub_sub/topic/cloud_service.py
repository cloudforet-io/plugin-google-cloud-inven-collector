...
topic_detail = ItemDynamicLayout.set_fields(
    "Topic Details",
    fields=[
        ...
        TextDyField.data_source(
            "Subscription count", "data.display.subscription_count"
        ),
        TextDyField.data_source("Retention duration", "data.display.retention"),
    ],
)

topic_subscription_meta = TableDynamicLayout.set_fields(
    "Subscriptions",
    ...
    fields=[
        ...
        EnumDyField.data_source(
            "State",
            "state",
            default_state={"safe": ["ACTIVE"], "alert": ["RESOURCE_ERROR"]},
        ),
        EnumDyField.data_source(
            "Delivery type",
            "delivery_type",
...
topic_snapshot_meta = TableDynamicLayout.set_fields(
    "Snapshots",
...
topic_meta = CloudServiceMeta.set_layouts(
    [topic_detail_meta, topic_subscription_meta, topic_snapshot_meta]
)
...
class TopicResource(PubSubResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=topic_meta, serialized_name="metadata"
    )
