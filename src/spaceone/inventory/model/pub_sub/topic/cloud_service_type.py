...
cst_topic.tags = {"spaceone:icon": f"{ASSET_URL}/cloud_pubsub.svg"}

cst_topic._metadata = CloudServiceTypeMeta.set_meta(
    fields=[
        EnumDyField.data_source(
            "Encryption key",
            "data.display.encryption_key",
            default_badge={
        ...
        TextDyField.data_source(
            "Schema name", "data.schema_settings.schema", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Message encoding",
            "data.schema_settings.encoding",
